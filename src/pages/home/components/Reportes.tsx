...
export default function Reportes() {
  const [activeTab, setActiveTab] = useState<'atrasos' | 'ruta' | 'exportar'>('atrasos');
    ...
    <div className="p-8">
      ...
      <div className="mb-6 inline-flex items-center gap-1 bg-gray-100 rounded-lg p-1">
        ...
        <button
          ...
          className={`px-4 py-2 rounded-md text-sm font-medium transition-colors cursor-pointer whitespace-nowrap ${
            activeTab === 'exportar' ? 'bg-white text-gray-900 shadow-sm' : 'text-gray-500 hover:text-gray-700'
          }`}
        >
...
function ExportarReportes() {
  ...
  const reportTypes = [
    { id: 'solicitudes-mes', name: 'Solicitudes del Mes', icon: 'ri-calendar-line', color: 'bg-teal-500' },
    { id: 'prioridad-alta', name: 'Alta Prioridad', icon: 'ri-alarm-warning-line', color: 'bg-red-500' },
    { id: 'por-solicitante', name: 'Por Solicitante', icon: 'ri-user-line', color: 'bg-amber-500' },
    { id: 'por-estado', name: 'Por Estado', icon: 'ri-pie-chart-line', color: 'bg-green-500' },
    { id: 'carga-trabajo', name: 'Carga de Trabajo', icon: 'ri-time-line', color: 'bg-orange-500' },
    { id: 'completo', name: 'Reporte Completo', icon: 'ri-file-list-3-line', color: 'bg-slate-500' }
  ];
